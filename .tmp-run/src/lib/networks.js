...
exports.invalidateNetworksCache = invalidateNetworksCache;
...
function invalidateNetworksCache() {
    networksCache = null;
}
async function getNetworks() {
    ...
    const docs = await (0, firestore_rest_1.fsQuery)("networks", [{ field: "active", op: "EQUAL", value: true }]);
    const data = docs;
...
async function getNetworkById(id) {
    ...
    const doc = await (0, firestore_rest_1.fsGet)("networks", id);
    return doc;
}
