...
export function detectNetwork(phone) {
    ...
    return (_a = networks.find((n) => n.prefixes.includes(prefix))) !== null && _a !== void 0 ? _a : null;
}
...
export function getBundlesByNetwork(networkId) {
...
export const trackOrders = [orders[0], orders[3], orders[11]];
