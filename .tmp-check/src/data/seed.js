...
// ---------------------------------------------------------------------------
// Avatar URLs (local)
const avatar = (id) => `/avatars/${id}.jpg`;
...
// ── Logo helper ────────────────────────────────────────────────────────────
export const logo = (domain) => `/logos/${domain.replace(/\./g, "-")}.png`;
...
export const categoryBreakdowns = [
...
// ══════════════════════════════════════════════════════════════════════════════
function generateSparkline(base, volatility) {
    const points = [];
    let price = base;
    for (let i = 0; i < 30; i++) {
...
export const financialHealthScore = {
    ...
    trendDelta: 3,
    factors: [
        { id: "hf1", label: "Savings Rate", score: 85, maxScore: 100, status: "excellent", description: "You save 28% of your income — well above the 20% target" },
        { id: "hf2", label: "Spending Habits", score: 72, maxScore: 100, status: "good", description: "Mostly within budget. Dining out is slightly over." },
        { id: "hf3", label: "Debt Ratio", score: 90, maxScore: 100, status: "excellent", description: "Debt-to-income ratio of 8% — very healthy" },
        { id: "hf4", label: "Investment Growth", score: 68, maxScore: 100, status: "good", description: "Portfolio up 12.4% YTD. Diversification is solid." },
        { id: "hf5", label: "Emergency Fund", score: 55, maxScore: 100, status: "fair", description: "3.2 months of expenses covered — aim for 6 months" },
        { id: "hf6", label: "Bill Payments", score: 95, maxScore: 100, status: "excellent", description: "All bills paid on time for 12 consecutive months" },
    ],
};
...
export const systemStatus = [
    ...
    { name: "Crypto Trading", status: "degraded" },
    { name: "International Transfers", status: "operational" },
