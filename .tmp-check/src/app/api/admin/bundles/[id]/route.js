...
export async function PATCH(req, context) {
    try {
        ...
        return NextResponse.json({
            success: true,
            bundle: Object.assign(Object.assign({}, bundle), nextPayload),
        });
    }
    catch (error) {
        console.error("[Admin Bundle Update Route] Error:", error);
        return NextResponse.json({ error: (error === null || error === void 0 ? void 0 : error.message) || "Failed to update bundle." }, { status: 500 });
    }
}
