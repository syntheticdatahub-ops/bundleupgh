...
export async function POST(request) {
    ...
    const reference = typeof (data === null || data === void 0 ? void 0 : data.reference) === "string" ? data.reference : "";
    if (!reference) {
    ...
    switch (event) {
        case "charge.success": {
            ...
            const snapshotAmount = Number((_a = order.sellingPriceSnapshot) !== null && _a !== void 0 ? _a : 0);
            ...
            const receivedAmount = Number((_b = data === null || data === void 0 ? void 0 : data.amount) !== null && _b !== void 0 ? _b : 0);
            if (String((data === null || data === void 0 ? void 0 : data.currency) || "GHS").toUpperCase() !== "GHS") {
            ...
            if (payment) {
                await fsUpdate("payments", payment.id, {
                    ...
                    currency: "GHS",
                    paidAt: (_c = data === null || data === void 0 ? void 0 : data.paid_at) !== null && _c !== void 0 ? _c : new Date().toISOString(),
                    updatedAt: new Date().toISOString(),
                });
            }
