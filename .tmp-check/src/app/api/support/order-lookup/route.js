...
export async function POST(req) {
    try {
        ...
        const rawPhone = typeof (body === null || body === void 0 ? void 0 : body.phoneNumber) === "string" ? body.phoneNumber.trim() : "";
        ...
        return NextResponse.json({ error: "I’m having trouble checking orders right now. Please try again in a moment or contact support." }, { status: 500 });
    }
}
