...
export default async function AdminOrdersPage({ searchParams, }) {
    ...
    return (_jsxs("div", { className: "flex flex-col gap-6 p-6", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Orders" }), _jsx("p", { className: "text-muted-foreground", children: "All transactions across every network." })] }), _jsx(AdminOrdersTable, { initialOrders: orders, networks: networks, currentPage: page, hasNextPage: hasNextPage, nextCursor: nextCursor })] }));
}
