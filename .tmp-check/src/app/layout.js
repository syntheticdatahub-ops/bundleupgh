...
export default function RootLayout({ children, }) {
    ...
    return (_jsxs("html", { lang: "en", className: `${geistSans.variable} ${geistMono.variable} h-full antialiased font-sans dark`, children: [_jsxs("head", { children: [_jsx("script", { type: "application/ld+json", dangerouslySetInnerHTML: { __html: JSON.stringify(jsonLd) } }), _jsx("link", { rel: "author", href: "/humans.txt" })] }), _jsxs("body", { className: "min-h-full flex flex-col bg-background text-foreground", children: [_jsxs(TooltipProvider, { children: [_jsx(GlobePreloader, {}), children] }), _jsx(Analytics, {}), _jsx(SpeedInsights, {})] })] }));
}
